...
void write_to_json_value(internal::internal_timer* obj, rapidjson::Value* json_value, Allocator& allocator) {
	if (!obj) {
...
void write_to_json_buffer(internal::internal_timer* obj, StringBuffer* buffer, Allocator& allocator) {
...
std::string write_to_json_string(internal::internal_timer* obj) {
