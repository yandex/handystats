...
void write_to_json_value(metrics::timer* obj, rapidjson::Value* json_value, Allocator& allocator) {
	if (!obj) {
...
void write_to_json_buffer(metrics::timer* obj, StringBuffer* buffer, Allocator& allocator) {
...
std::string write_to_json_string(metrics::timer* obj) {
