...
TEST(CounterEventsTest, TestCounterInitEvent) {
	...
	auto message = counter_init_event(counter_name, init_value);
...
TEST(CounterEventsTest, TestCounterIncrementEvent) {
	...
	auto message = counter_increment_event(counter_name, value);
...
TEST(CounterEventsTest, TestCounterDecrementEvent) {
	...
	auto message = counter_decrement_event(counter_name, value);
