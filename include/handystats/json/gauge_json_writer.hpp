...
void write_to_json_value(metrics::gauge* obj, rapidjson::Value* json_value, Allocator& allocator) {
	if (!obj) {
...
void write_to_json_buffer(metrics::gauge* obj, StringBuffer* buffer, Allocator& allocator) {
...
std::string write_to_json_string(metrics::gauge* obj) {
